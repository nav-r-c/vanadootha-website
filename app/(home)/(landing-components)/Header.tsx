        ...
        <div className="relative">
            <div className="h-screen lg:w-[45%] absolute text-white h-screen flex flex-col justify-center items-center text-center lg:text-left">
                ...
                >
                    ...
                    <p className="text-xl md:text-2xl my-10 text-secondary-2">With our smart & autonomous product, you don't have to worry about guarding your fields all night!</p>
                    <Link href = '#contact-us' className="font-bold bg-primary-2 rounded-full p-2 px-5 text-black text-lg md:text-xl transition-all ease-in-out hover:scale-110">Contact Us</Link>
                </motion.div>
            </div>
            <div>
