...
function FeatureCard(props : PropTypes) {
    return (
        <>
        <div className='p-10 bg-white rounded-md shadow-lg flex flex-col justify-center items-center'>
            <Image src = {props.image} width={50} height={50} alt = "Feature" className='my-5' />
            <h1 className='text-accent-4 font-bold text-xl my-2'>{props.heading}</h1>
